...
def build_retrievers(chunk_texts: List[str]):
    ...
    print("  Building Hybrid retriever with normalization and reranking...")
    hybrid = HybridRetriever(
        dense,
        bm25,
        alpha=0.6,
        use_reranker=True,  # enables cross-encoder reranker
...
def setup_reader(api_key: str = None):
    ...
    if not api_key:
        print("Warning: No API key found. Using placeholder.")
